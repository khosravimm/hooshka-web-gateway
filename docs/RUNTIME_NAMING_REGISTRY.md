...
|---|---|---|---|
| `chatgpt-web` | `HWG-ChatGPT-Web-CDP` | existing user Chrome CDP, not bridge-owned | `operational-e2` |
| `qwen-web` | `HWG-Qwen-Web-Controller` | `.runtime\\qwen-profile` | `operational-e2` |
| `zai-web` | `HWG-Zai-Web-SSE-Capture` | `.runtime\\zai-profile` or legacy `.runtime\\zai-cdp-profile` | `operational-e2-basic-chat` |
