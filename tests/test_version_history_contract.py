...
def test_dev5_change_history_and_schema_contracts_exist():
    changelog = (ROOT / "CHANGELOG.md").read_text(encoding="utf-8-sig")
    record = ROOT / "docs/governance/HWG_1.0.0-dev.5_CHANGE_RECORD_20260921.md"
    assert "## 1.0.0-dev.5 - 2026-09-21" in changelog
